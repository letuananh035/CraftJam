...
case "easeinbounce":
{
return change - easings("easeoutbounce",0,change,duration,(duration - time)) + start;
}
case "easeoutbounce":
{
time /= duration;
...
{
    return (easings("easeinbounce",0,change,duration,time*2)*0.5 + start);
}

return (easings("easeoutbounce",0,change,duration,time*2 - duration)*0.5 + change*0.5 + start);
}
default:
return "418";
}
