...
var yy = o_player.y-6+o_player.z_;
	...
	repeat(global.p1_bullet_count+1){
		...
		var offset = 45;
		if dir > i-offset and dir <= i+offset{
			dir = i;
			
		}else if dir > i*3-offset and dir <= i*3+offset{
			dir = i*3;
			
		}else if dir > i*5-offset and dir <= i*5+offset{
			dir = i*5;
			
		}else if dir > i*7-offset and dir <= i*7+offset{
			dir = i*7;
			...
			/*(
		}else if dir > i*2-offset and dir <= i*3+offset{
		dir = i*2;	
			
			
		}else if dir > i*3-offset and dir <= i*4+offset{
		dir = i*3;	
			
			
		}else if dir > i*4-offset and dir <= i*5+offset{
		dir = i*4;	
