...
audio_master_gain(.5);
=======
>>>>>>> 40cd56bb727fd16dcdcd1c5cd4c122358801db32
...
if room != r_tutorial and room != r_main{
	...
	var col2 = C_PURPLE;
		...
		if instance_exists(o_cutscene_alien_lv_2) and o_cutscene_alien_lv_2.state > 2{
		nine_slice_image_blend(s_nine_slice_border,x_-16+16,16+y_+y_nine_offset-3,x_+16+16,16+y_+y_nine_offset+3,1,choose(c_white,C_DARK));
		}
