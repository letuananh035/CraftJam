/// @description 
var vol = 1-fade_black_alpha;
vol = clamp(vol,0,1);
audio_emitter_gain(at_last,vol);
...
if show_option = true {
	switch current_choice{
		...
		case -1: if o_game.space{ 
			audio_play_sound_on(at_last,a_at_last,0,9)
...
if state_manual_move = true and end_cutscene = false and !fade_black  and !instance_exists(o_fade_out)  {
	...
	switch state {
		...
		case 1: current_text = "im_just_stalling"; black_foreground = false; break;
