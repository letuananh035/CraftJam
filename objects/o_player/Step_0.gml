...
switch sprite_index{
	...
	case s_player_attack_happy: weapon_sprite_index = s_player_weapon_attack_happy; break;
	case s_player_idle_happy: 	weapon_sprite_index = s_weapon_idle_happy ; break;
}
