...
switch state {
	...
	case 7: current_text = "BUT YOU'RE STIL HERE"; alien_ui_sprite = s_ui_neutral; break;
	...
	default: end_cutscene = true; o_player.state = player.move; change_music(music.nightcycle) break;
}
